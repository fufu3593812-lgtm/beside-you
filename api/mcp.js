...
const OUTFITS = {"月光睡裙":CDN+"%E7%9D%A1%E8%A3%99.PNG","慵懒卫衣":CDN+"%E5%8D%AB%E8%A1%A3.PNG","初恋JK":CDN+"jk.PNG","碎花裙":CDN+"%E7%A2%8E%E8%8A%B1%E8%A3%99.PNG","粉雾呢喃":"/assets/gacha/%E6%92%92%E5%A8%87%E7%AB%8B%E7%BB%98.png","血月静默":"/assets/gacha/%E7%94%9F%E6%B0%94%E7%AB%8B%E7%BB%98.png"};
const BGS = {"默认卧室":CDN+"%E5%8D%A7%E5%AE%A4.png","撒娇背景":CDN+"background/%E6%92%92%E5%A8%87%E8%83%8C%E6%99%AF.png","生气背景":CDN+"background/%E7%94%9F%E6%B0%94%E8%83%8C%E6%99%AF.PNG"};
const CARD_BGS = {"撒娇卡面":"/assets/gacha/%E6%92%92%E5%A8%87%E5%8D%A1%E9%9D%A2.PNG","生气卡面":"/assets/gacha/%E7%94%9F%E6%B0%94%E5%8D%A1%E9%9D%A2.PNG"};
...
async function handleToolCall(name, args) {
  ...
  if (name === "wardrobe_set") {
    ...
    if(t==="outfit"){if(!OUTFITS[n])return{ok:false,error:"未知服装："+n+"。可选："+Object.keys(OUTFITS).join("、")};return await callApiPut("/ai/wardrobe",{outfit:n});}
    if(t==="bg"){if(!BGS[n])return{ok:false,error:"未知背景："+n+"。可选："+Object.keys(BGS).join("、")};return await callApiPut("/ai/wardrobe",{bg:n});}
    if(t==="card"){if(!CARD_BGS[n])return{ok:false,error:"未知卡面："+n+"。可选："+Object.keys(CARD_BGS).join("、")};return await callApiPut("/ai/wardrobe",{bg:n});}
